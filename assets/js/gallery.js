...
Fancybox.bind("[data-fancybox]", {
    Toolbar: {
      display: [
        ...
        "close",
        {
          tpl: `<button class="fancybox__toolbar__button" data-share>Share</button>`,
          click: (fancybox, event) => {
            const currentImage = fancybox.getSlide();
            const imageUrl = currentImage.src;
            const shareText = `Check out this image from Kumwe Green Farms: ${imageUrl}`;
